  ...
  return (
    <div className={`podium-person place-${place}`}>
      <div className="podium-character">
        <div className="podium-head"><UserAvatar user={user} size={58} /></div>
        <div className="podium-body"><span className="podium-arm left" /><span className="podium-torso" /><span className="podium-arm right" /></div>
      </div>
