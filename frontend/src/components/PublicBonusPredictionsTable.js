  ...
  return (
    <div className="public-bonus-table-shell">
      ...
      <style>{`
        ...
        .public-bonus-panel-title strong { color: #0f172a; font-size: 13px; }
        ...
        .public-bonus-row { display: grid; gap: 8px; align-items: center; padding: 8px; border-radius: 13px; background: #f8fafc; border: 1px solid #e2e8f0; }
        .public-bonus-row.is-groups { grid-template-columns: minmax(145px, .95fr) repeat(12, 44px) auto; }
        .public-bonus-row.is-final { grid-template-columns: minmax(150px, .9fr) minmax(90px, .7fr) minmax(90px, .7fr) minmax(185px, 1.2fr) auto; }
        .public-bonus-row.is-current-user { background: #fff7ed; border-color: #f59e0b; }
        .public-bonus-head { background: #f1f5f9; color: #64748b; font-size: 10px; font-weight: 950; text-transform: uppercase; letter-spacing: .05em; }
        .public-bonus-user { display: inline-flex; align-items: center; gap: 8px; min-width: 0; }
        .public-bonus-user strong { min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: #0f172a; font-size: 12px; }
        .public-bonus-flag { width: 28px; height: 28px; display: inline-grid; place-items: center; border-radius: 999px; background: white; border: 1px solid #e2e8f0; box-shadow: 0 5px 12px rgba(15,23,42,.08); }
        .public-bonus-flag img { width: 100%; height: 100%; border-radius: 50%; object-fit: cover; }
        .public-bonus-semis { display: flex; flex-wrap: wrap; gap: 5px; }
        .public-bonus-empty { color: #94a3b8; font-weight: 950; }
        .public-bonus-points { justify-self: end; padding: 5px 8px; border-radius: 999px; background: #eff6ff; color: #1d4ed8; font-size: 10px; font-weight: 950; white-space: nowrap; }
