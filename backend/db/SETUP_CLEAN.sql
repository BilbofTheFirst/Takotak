...
((SELECT id FROM teams WHERE name='Canada'), (SELECT id FROM teams WHERE name='Qatar'), '2026-06-20 00:00:00+02', 'pending'),
...
((SELECT id FROM teams WHERE name='Maroc'), (SELECT id FROM teams WHERE name='Haïti'), '2026-06-25 01:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='Écosse'), (SELECT id FROM teams WHERE name='Brésil'), '2026-06-25 01:00:00+02', 'pending');
...
((SELECT id FROM teams WHERE name='Australie'), (SELECT id FROM teams WHERE name='États-Unis'), '2026-06-19 21:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='Turquie'), (SELECT id FROM teams WHERE name='Paraguay'), '2026-06-20 05:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='Turquie'), (SELECT id FROM teams WHERE name='États-Unis'), '2026-06-25 04:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='Paraguay'), (SELECT id FROM teams WHERE name='Australie'), '2026-06-25 04:00:00+02', 'pending');
...
-- Groupe G
INSERT INTO matches (team1_id, team2_id, start_time, status) VALUES
((SELECT id FROM teams WHERE name='Belgique'), (SELECT id FROM teams WHERE name='Égypte'), '2026-06-14 21:00:00+02', 'pending'),
...
((SELECT id FROM teams WHERE name='Uruguay'), (SELECT id FROM teams WHERE name='Cap-Vert'), '2026-06-21 22:00:00+02', 'pending'),
...
((SELECT id FROM teams WHERE name='Norvège'), (SELECT id FROM teams WHERE name='Sénégal'), '2026-06-27 04:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='France'), (SELECT id FROM teams WHERE name='Irak'), '2026-06-27 04:00:00+02', 'pending');
...
((SELECT id FROM teams WHERE name='Colombie'), (SELECT id FROM teams WHERE name='Portugal'), '2026-06-29 01:00:00+02', 'pending'),
((SELECT id FROM teams WHERE name='RD Congo'), (SELECT id FROM teams WHERE name='Ouzbékistan'), '2026-06-29 01:00:00+02', 'pending');
...
((SELECT id FROM teams WHERE name='Ghana'), (SELECT id FROM teams WHERE name='Angleterre'), '2026-06-22 23:00:00+02', 'pending'),
...
(NULL, NULL, '2026-07-04 01:00:00+02', 'pending'),
